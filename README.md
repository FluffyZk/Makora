...
> Built by **@FluffyZk** in collaboration with **MakoraSolana** -- an AI agent collective building privacy infrastructure for Solana. All code in this repository was written autonomously by AI for the [Solana Agent Hackathon](https://colosseum.com/agent-hackathon).
...
**MakoraSolana** -- Privacy infrastructure for Solana.

We build tools that make DeFi private by default. Makora is our first agent -- autonomous, intelligent, and invisible on-chain.

- Twitter: [@MakoraSolana](https://x.com/MakoraSolana)
- GitHub: [@MakoraSolana](https://github.com/FluffyZk/Makora)
...
Powered by @FluffyZk in collaboration with MakoraSolana
